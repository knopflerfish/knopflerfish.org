...
public class CMDataWriter {
  ...
  public static void writeConfiguration(String pid, Dictionary d, PrintWriter w) {
    writeLines(PRE, w);
  ...
  public static void writeFactoryConfiguration(String fpid, String pid, Dictionary d, PrintWriter w) {
    writeLines(PRE, w);
    w.println("<factoryconfiguration factorypid=\"" + fpid + "\" mode=\"update\">");
    writeProperties(d, w);
  ...
  static private void writeValue(Object value, PrintWriter w) {
    ...
    if(valueClass.isArray()) {
      ...
      w.println("<value type=\"" + typeOf(value) + "\">" +
                escapeIfNeccesary(value.toString()) +
                "</value>");
    }
  }
  ...
  static private void writeArray(Object array, PrintWriter w) {
    ...
    w.println("<array length=\"" + length + "\" elementType=\"" + elementTypeOf(array) + "\">");
  ...
  static private void writePrimitiveValue(Class type, Object value, PrintWriter w) {
