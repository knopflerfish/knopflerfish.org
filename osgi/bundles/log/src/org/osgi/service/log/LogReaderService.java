/*
 * $Header: /home/wistrand/cvs/knopflerfish.org/osgi/bundles/log/src/org/osgi/service/log/LogReaderService.java,v 1.1.1.1 2004/03/05 20:35:13 wistrand Exp $
 *
...
public abstract interface LogReaderService {
     ...
     * 
     * @param listener
     *            A <tt>LogListener</tt> object to register; the
     *            <tt>LogListener</tt> object is used to receive
     *            <tt>LogEntry</tt> objects.
     * @see LogListener
     * @see LogEntry
     * @see LogListener#logged(LogEntry)
     */
     ...
     * 
     * @param listener
     *            A <tt>LogListener</tt> object to unregister.
     * @see LogListener
     */
