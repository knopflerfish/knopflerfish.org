/*
 * $Header: /home/wistrand/cvs/knopflerfish.org/osgi/bundles/log/src/org/osgi/service/log/LogService.java,v 1.1.1.1 2004/03/05 20:35:13 wistrand Exp $
 *
...
public abstract interface LogService {
     ...
     * 
     * @param sr
     *            The <tt>ServiceReference</tt> object of the service that
     *            this message is associated with or <tt>null</tt>.
     * @param level
     *            The severity of the message. This should be one of the defined
     *            log levels but may be any integer that is interpreted in a
     *            user defined way.
