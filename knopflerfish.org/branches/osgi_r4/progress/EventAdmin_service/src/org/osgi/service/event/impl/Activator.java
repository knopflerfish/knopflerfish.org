...
/**
 * The Activator class is the startup class for the
 * EventHandlerService.
 * 
 * @author Magnus Klack
 */
public class Activator implements BundleActivator{
	 ...
	 * 
	 * @param 	context the BundleContext ,ie, the handle to 
	 * 			the OSGi framework 
	 */
	public void start(BundleContext context) throws Exception {
		...
		serviceRegistration = bundleContext.registerService(
				EventAdmin.class.getName(),eventAdmin,propsTable);
