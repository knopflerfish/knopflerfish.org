 ...
 */
package com.gstm.test.scr.scenarios.scenario4.immediatecomponent2.impl;
 ...
 * @author Martin
 */
public class ImmediateComponent2Impl implements ImmediateComponent2{
	...
	protected void bindDelayedComponent1(DelayedComponent1 provider){
		...
		board.setValue("com.gstm.test.scr.scenarios.scenario4.immediatecomponent2.ImmediateComponent2", new Integer(serviceValue));
	}
