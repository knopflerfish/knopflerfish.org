 ...
 */
package com.gstm.test.scr.scenarios.scenario8.component2.impl;

import org.osgi.service.component.ComponentContext;

import com.gstm.test.scr.scenarios.scenario8.component2.Component2;
...
public class Component2Impl implements Component2 {
    ...
    public Component2Impl(){
    	...
    	board.setValue("com.gstm.test.scr.scenarios.scenario8.component2.Component2", new Integer(10));
    }
    ...
    public void activate(ComponentContext context) { 
		...
		if(provider!=null){
			...
			board.setValue("com.gstm.test.scr.scenarios.scenario8.component2.Component2", new Integer(serviceValue));
		}
    }
}
