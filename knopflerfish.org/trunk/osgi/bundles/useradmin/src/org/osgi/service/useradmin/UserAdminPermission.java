/*
 * $Header: /home/wistrand/cvs/knopflerfish.org/osgi/bundles/useradmin/src/org/osgi/service/useradmin/UserAdminPermission.java,v 1.1.1.1 2004/03/05 20:35:16 wistrand Exp $
 *
...
public final class UserAdminPermission extends BasicPermission {
    ...
    private static final int ACTION_ALL = ACTION_CHANGE_PROPERTY
            | ACTION_CHANGE_CREDENTIAL | ACTION_GET_CREDENTIAL;
     ...
     * 
     * @param name
     *            the name of this <tt>UserAdminPermission</tt>
     * @param actions
     *            the action string.
     * 
     * @throws IllegalArgumentException
     *             If <tt>name</tt> equals &quot;admin&quot; and
     *             <tt>actions</tt> are specified.
     */
    ...
    private static int getMask(String actions) {
        ...
        while (i != -1) {
            ...
            } else if (i >= 13 && match_change(a, i - 8)
                    && match_property(a, i)) {
                matchlen = 14;
                mask |= ACTION_CHANGE_PROPERTY;

            } else if (i >= 15 && match_change(a, i - 10)
...
final class UserAdminPermissionCollection extends PermissionCollection {
     ...
     * 
     * @throws IllegalArgumentException
     *             If the given permission is not a <tt>UserAdminPermission</tt>
     * @throws SecurityException
     *             If this <tt>UserAdminPermissionCollection</tt> object has
     ...
     * 
     * @param permission
     *            the <tt>Permission</tt> object to check against
     * 
