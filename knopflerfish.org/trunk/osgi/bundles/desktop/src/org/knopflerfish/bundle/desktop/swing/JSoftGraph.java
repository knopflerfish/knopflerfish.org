...
public abstract class JSoftGraph extends JPanel {
  ...
  private BufferedImage createReflectedPicture(BufferedImage image, int y0) {
    int imageWidth = image.getWidth();
    int imageHeight = y0;
    
    BufferedImage gradient = createGradientMask(imageWidth, imageHeight);
    BufferedImage buffer   = createReflection(image,
                                              imageWidth, 
                                              imageHeight);
    
    applyAlphaMask(gradient, buffer, imageWidth, imageHeight);
  ...
  private void applyAlphaMask(BufferedImage gradient,
    ...
    g2.drawImage(gradient, null, 0, imageHeight);
    g2.dispose();
  }


  private BufferedImage createGradientMask(int imageWidth, int imageHeight) {
    BufferedImage gradient = new BufferedImage(imageWidth, imageHeight,
                                               BufferedImage.TYPE_INT_ARGB);
    Graphics2D g = gradient.createGraphics();
    GradientPaint painter = new GradientPaint(0.0f, 0.0f,
                                              new Color(1.0f, 0f, 0f, 0.5f),
                                              0.0f, imageHeight / 2.0f,
                                              new Color(0f, 0f, 1.0f, 0.0f));
    g.setPaint(painter);
  ...
  static AffineTransform reflectTransform = AffineTransform.getScaleInstance(1.0, -1.0);
  private BufferedImage createReflection(BufferedImage image,
                                         int imageWidth,
                                         int imageHeight) {
    
    BufferedImage buffer = new BufferedImage(imageWidth, 
                                             imageHeight,
                                             BufferedImage.TYPE_INT_ARGB);
