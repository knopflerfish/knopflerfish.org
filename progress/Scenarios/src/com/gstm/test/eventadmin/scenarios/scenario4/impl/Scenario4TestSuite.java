...
public class Scenario4TestSuite extends TestSuite implements Scenario4 {
    ...
    public void setUp() {
        ...
        /* put some properties into the hashtable */
        ...
        String scenario4_filter5 = "(month=2004)";

        /* add the event consumers to the test suite */
        addTest(new EventConsumer(bundleContext, scenario4_topics1, 
        		scenario4_filter1, "Scenario 4 EventConsumer1", 4));
        addTest(new EventConsumer(bundleContext, scenario4_topics1, 
        		scenario4_filter2, "Scenario 4 EventConsumer2", 4));
        addTest(new EventConsumer(bundleContext, scenario4_topics1, 
        		scenario4_filter3, "Scenario 4 EventConsumer3", 4));
        addTest(new EventConsumer(bundleContext, scenario4_topics1, 
        		null, "Scenario 4 EventConsumer4", 4));
        addTest(new EventConsumer(bundleContext, scenario4_topics1, 
        		scenario4_filter5, "Scenario 4 EventConsumer5", 4));
        
        /* add the event publisher to the test suite */
        addTest(new EventPublisher(bundleContext, "Scenario 4 EventPublisher", 
    ...
    class EventConsumer extends TestCase implements EventHandler {
        ...
        public EventConsumer(BundleContext bundleContext, String[] topics,
        		String filter, String name, int id) {
            /* call super class */
            super(name + ":" + id);
