 ...
 */
package com.gstm.test.scr.scenarios.scenario6.component2.impl;

import org.osgi.service.component.ComponentContext;

import com.gstm.test.scr.scenarios.scenario6.component2.Component2;
...
public class Component2Impl implements Component2 {
    ...
    public void activate(ComponentContext context) { 
		...
		if(provider!=null){
			System.out.print("Component2 getting values from counterFactory:");
			for(int i=0 ; i<50 ; i++){
				...
				board.setValue("com.gstm.test.scr.scenarios.scenario6.component2.Component2", new Integer(serviceValue));
			}
			/* New line */
			System.out.println("");
		}
